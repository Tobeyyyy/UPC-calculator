...
def roundup(a, digits=0):#round up function to round at ten digit.
		n = 10**-digits
		return round(math.ceil(a / n) * n, digits)
		
def UPCAlgorithm_12(UPC_11):#get 12 digit UPC
		UPC_11=str(UPC_11)
